...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('fontend/it-solutionsbd/assets/img/favicon.ico')}}">
    ...
    <!-- Vendor CSS -->
    <link href="{{ asset('fontend/it-solutionsbd/assets/css/vendors.css')}}" rel="stylesheet">
    <!-- Main CSS -->
    <link href="{{ asset('fontend/it-solutionsbd/assets/css/style.css')}}" rel="stylesheet">
                            ...
                            <div class="navigation-top-search-area pt-25 pb-25">
                                <div class="row align-items-center">
                                    <div class="col-6 col-xl-2 col-lg-3 order-1 col-md-6 col-sm-5">
                                        ...
                                        <div class="logo">
                                            <a href="index-2.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/logo-alula2.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 order-3 order-sm-2 order-lg-3 order-xs-3 col-md-4 col-sm-5 text-center text-sm-left mt-xs-25">
                                        ...
                                        <div class="customer-support-text">
                                            <div class="icon">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/icons/icon-header-phone-green.png')}}" class="img-fluid" alt="">
                                            </div>
                                            ...
                                            <div class="small-cart deactive-dropdown-menu">
                                                <div class="small-cart-item-wrapper">
                                                    <div class="single-item">
                                                        <div class="image">
                                                            <a href="single-product.html">
                                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/cart-image/small1-90x90.jpg')}}" class="img-fluid" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="content">
                                                    ...
                                                    <div class="single-item">
                                                        ...
                                                        <div class="image">
                                                            <a href="single-product.html">
                                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/cart-image/small2-90x90.jpg')}}" class="img-fluid" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="content">
                                        ...
                                        <ul class="mega-menu four-column">
                                            ...
                                            <li class="megamenu-banner d-none d-lg-block mt-30 w-100">
                                                <a href="shop-left-sidebar.html" class="mb-0">
                                                    <img src="{{ asset('fontend/it-solutionsbd/assets/img/banners/img-bottom-menu.jpg')}}" class="img-fluid" alt="">
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <div class="hero-slider-wrapper">
                        ...
                        >
                            ...
                            <div class="single-slider-item">
                                <div class="hero-slider-item-wrapper hero-slider-bg-7">
                            ...
                            <div class="single-slider-item">
                                <div class="hero-slider-item-wrapper hero-slider-bg-8">
                                    <div class="hero-slider-content pl-60 pl-sm-30">
                                        <p class="slider-title slider-title--small">Workshops @Alula</p>
                                        <p class="slider-title slider-title--big-bold">Furniture Make</p>
                            ...
                            <div class="single-slider-item">
                                <div class="hero-slider-item-wrapper hero-slider-bg-9">
                                    <div class="hero-slider-content pl-60 pl-sm-30">
                                        <p class="slider-title slider-title--small">Thursday Through Saturday</p>
                                        <p class="slider-title slider-title--big-bold">Furniture Big Sale</p>
                    ...
                    <div class="icon-feature-wrapper">
                        <div class="row row-5">
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/icons/free_shipping.png')}}" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/icons/support247.png')}}" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/icons/moneyback.png')}}" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/icons/payment_secure.png')}}" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                            ...
                            >
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium18.jpg')}}" class="img-fluid" alt="">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium19.jpg')}}" class="img-fluid" alt="">
                                            </a>
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium20.jpg')}}" class="img-fluid" alt="">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium21.jpg')}}" class="img-fluid" alt="">
                                            </a>
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium22.jpg')}}" class="img-fluid" alt="">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium23.jpg')}}" class="img-fluid" alt="">
                                            </a>
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium24.jpg')}}" class="img-fluid" alt="">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium25.jpg')}}" class="img-fluid" alt="">
                                            </a>
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium26.jpg')}}" class="img-fluid" alt="">
                                            </a>
                ...
                <div class="row row-5">
                        ...
                        <div class="single-split-banner">
                            <div class="single-split-banner__image">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('fontend/it-solutionsbd/assets/img/banners/banner6.jpg')}}" class="img-fluid" alt="">
                                    <div class="single-split-banner__image__content">
                                        <p class="split-banner-title split-banner-title--light">New Collection</p>
                                        <p class="split-banner-title split-banner-title--bold">Roma ArmChair</p>
                    ...
                    <div class="col-md-6 mb-sm-10">
                        ...
                        <div class="single-split-banner">
                            <div class="single-split-banner__image">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('fontend/it-solutionsbd/assets/img/banners/banner7.jpg')}}" class="img-fluid" alt="">
                                    <div class="single-split-banner__image__content">
                                        <p class="split-banner-title split-banner-title--light">The Original</p>
                                        <p class="split-banner-title split-banner-title--bold">Toby Chair</p>
                            ...
                            >
                                ...
                                <div class="single-slider-product-wrapper">
                                    <div class="single-slider-product">
                                        <div class="single-slider-product__image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium27.jpg')}}" class="img-fluid" alt="">
                                                <img src="{{ asset('fontend/it-solutionsbd/assets/img/products/medium28.jpg')}}" class="img-fluid" alt="">
                                            </a>
                        ...
                        <div class="brand-logo-slider-wrapper brand-logo-slider-wrapper--double-border">
                            ...
                            >
                                ...
                                <div class="single-brand-logo">
                                    <a href="#">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/brands/brand1.png')}}" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="single-brand-logo">
                                    <a href="#">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/brands/brand2.png')}}" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="single-brand-logo">
                                    <a href="#">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/brands/brand3.png')}}" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="single-brand-logo">
                                    <a href="#">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/brands/brand4.png')}}" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="single-brand-logo">
                                    <a href="#">
                                        <img src="{{ asset('fontend/it-solutionsbd/assets/img/brands/brand5.png')}}" class="img-fluid" alt="">
                                    </a>
                                </div>
