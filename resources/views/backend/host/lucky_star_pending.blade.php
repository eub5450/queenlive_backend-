              ...
              <div class="col-md-12">
                  <div class="card">
                      <div class="card-header d-flex align-items-center">
                          <h4> Pending Lucky Star Host List</h4>
                      </div>
                ...
                <tbody>
                 ...
                 @endphp
                  <tr>
                    ...
                    <td>
                       <a href="{{URL::to('lucky_star_actived/'.$item->id)}}" class="btn btn-sm btn-success" ><span class="fa fa-check"></span></a>
                       <a href="{{URL::to('lucky_star_rejected/'.$item->id)}}" class="btn btn-sm btn-danger" ><span class="fa fa-trash"></span></a>
