...
<html>
  <head>
    ...
    <style>
        body{
          background-image: url('{{asset('public/game/fruits/')}}/images/cool-geometric-triangular-hallway-3d-rendering.jpg');
        }
    </style>
  </head>
  ...
  <body >
    ...
    <div class="start" id="start">Start Bet</div>
    ...
    <div class="pot" id="pot">
        <div class="topuser">
          <div><img class="userbg" src="{{asset('public/game/fruits/')}}/images/boardsasaasasas.png" /><img class="userimg" src="{{asset('public/game/fruits/')}}/images/user_icon.png" /></div>
          <div>
            <img class="userbg" src="{{asset('public/game/fruits/')}}/images/boardsasaasasas.png" /><img class="userimg" src="{{asset('public/game/fruits/')}}/images/user_icon.png" />
            </div>
        </div>
