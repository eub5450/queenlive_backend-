...
/**
 * Audio-room adapter stub. Agent C fills in seat layout, super_mute and
 * pending-call semantics. The shared RoomActionService should never crash
 * because of a missing adapter, hence the noop returns.
 */
class AudioAdapter implements AdapterInterface
{
